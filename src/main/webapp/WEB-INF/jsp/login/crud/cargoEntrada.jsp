					...
					<tbody>
						<c:forEach items="${listaTela}" var="tela" varStatus="loop">
							<tr class="row telas" id="linhaTela${tela.id}">
								<td class="col-12">
									<button type="button" id="btnAdd${tela.id}" onclick="addPermission(this, ${tela.id}, '${tela.uri}');" class="btn btn-success btn-sm btnAdd" title="Adicionar permissão">
...
<script>
	...
	function addPermission(el, id, uri){
